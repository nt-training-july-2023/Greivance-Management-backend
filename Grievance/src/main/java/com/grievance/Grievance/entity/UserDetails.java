...
public class UserDetails {
  ...
  /**
   * One-to-many relationship mapping to associate this entity with a list of
   * Comment entities. This field represents the list of comments associated with
   * this entity.
   */
  ...
  public UserDetails(long userId,
      ...
      UserType usertype, Boolean isLoggedIn, Department department,
      List<Ticket> tickets) {
    super();
    this.userId = userId;
    this.name = name;
  ...
  /**
   * Default constructor for creating a new. UserDetails instance. Initializes the
