...
public class DepartmentController {
  ...
  public ResponseEntity<DepartmentOutDto> createDepartment(
      @Validated @RequestBody DepartmentInDto departmentInDto) {
    DepartmentOutDto departmentOutDto = departmentService
        .createDepartment(departmentInDto);
    ResponseEntity<DepartmentOutDto> createdResponse = new ResponseEntity<DepartmentOutDto>(
        departmentOutDto, HttpStatus.CREATED);
  ...
  public ResponseEntity<List<DepartmentOutDto>> getAllDepartment(
    ...
    List<DepartmentOutDto> departmentOutDtoslist = departmentService
  ...
  public ResponseEntity<DepartmentOutDto> getDepartmentById(
